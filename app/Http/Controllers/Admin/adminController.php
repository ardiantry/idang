...
class adminController extends Controller
{
    ...
    public function adminhajatan(Request $request)
    {
        return view('admin.hajatan.list');
    }
    ...
    public function adminmasyarakat(Request $request)
    {
        ...
        return view('admin.masyarakat.list', compact('dt_tamu'));
    }
