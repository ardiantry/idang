...
function getalamat(id_tamu=undefined)
	{
		...
		$('#alamat').html('<div  class="form-group"><label>Alamat</label><textarea readonly="readonly" class="form-control" name="alamat">'+alamat+'</textarea></div><div  class="form-group"><label>Nama Kondangan</label><input readonly="readonly" class="form-control" value="'+nm_kondnagan+'"></div>');
	}
